---
name: 0.3.6-understand-ethanol
description: "[0.3.6] Alcohol produced by wild_yeast during anaerobic fermentation that evaporates during baking and contributes to "
---
...
`fermentation_byproducts`, `wild_yeast`
