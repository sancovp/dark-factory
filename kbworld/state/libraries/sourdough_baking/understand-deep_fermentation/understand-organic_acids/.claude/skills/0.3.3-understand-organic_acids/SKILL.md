---
name: 0.3.3-understand-organic_acids
description: [0.3.3] Carbon-chain acids produced by lactobacillus metabolism including lactic_acid and acetic_acid that determine s
---

# understand-organic_acids

**CALL NUMBER:** `deep_fermentation.organic_acids : sourdough_baking(1)`
...
`acid_generation_rate`, `fermentation_byproducts`, `fermentation_vigor`, `lactobacillus`
