---
name: 0.4.1-understand-sourdough_starter
description: [0.4.1] A fermented mixture of flour and water containing wild yeast and lactic acid bacteria that serves as the natur
---

# understand-sourdough_starter

**CALL NUMBER:** `sourdough_baking.sourdough_starter : deep_sourdough_starter(5), deep_fermentation(1)`
