---
name: 0.1.2-understand-flavor_complexity
description: [0.1.2] The depth and nuance of sourdough taste arising from multiple organic acids, esters, and alcohols produced dur
---

# understand-flavor_complexity

**CALL NUMBER:** `?.flavor_complexity`
